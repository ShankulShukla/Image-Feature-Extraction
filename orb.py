...
# Using orb feature extractor to find the useful features then create a bag of visual words model so fitting a machine learning model on it.
...
# Applying orb feature extractor on the same image

orb = cv2.ORB_create(300)
kp = orb.detect(edge,None)
...
#lets cluster these descriptors in the images and bag of features representation
#Differentiating features of each image
train_desc = []
