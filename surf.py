...
# Using surf feature extractor to find the useful features then create a bag of visual words model so fitting a machine learning model on it.
...
# As SURF tend to perform the best amoung all feature extractors lets visualize the confusion matrix fro the same
x = clf.predict(x_val)
